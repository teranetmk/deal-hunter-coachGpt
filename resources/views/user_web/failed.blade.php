    ...
    <div class="row justify-content-center">
        <div class="col-lg-7 col-md-8 col-12">
            <div class="theme-card-popup">
                <div class="icon-group icon-group-danger mb-3">
                    <img src="{{ asset('assets/images/icons/processing.png') }}" height="22"
                        alt="icon">
                </div>
                <h3 class="heading-h3 fw-bold mb-3">Sorry! We Need More Info To Make Offer</h3>
                <p class="description mb-3">Call, Text, Or Email Us Below And We Will Be Able To Make An Offer On Your Property!</p>
                ...
                <img src="{{ asset('assets/images/icons/processing-overlay.png') }}" alt="overlay" height="150" class="overlay-img">
            </div>
        </div>
    </div>
@endsection
