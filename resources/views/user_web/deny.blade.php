    ...
    <div class="row justify-content-center">
        <div class="col-lg-7 col-md-8 col-12">
            <div class="theme-card-popup">
                ...
                <h3 class="heading-h3 fw-bold mb-3">Wait! Please Contact Us For More Info</h3>
                <p class="description mb-3">We Will Ask For More Details To See If We Can Get You A Better Offer!</p>
