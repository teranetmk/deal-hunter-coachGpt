...
onMounted(() => {
    if (!form.phone_country_code || !form.phone_country_code.length) {
        form.phone_country_code = "us";
    }
});
...
<template>
    <GuestLayout>
        ...
        <div
            class="grid flex justify-content-center align-content-center"
            style="margin-top: 4rem"
        >
            <div
                class="col-12 sm:col-10 md:col-8 lg:col-6 xl:col-6 border-1 border-400 border-round"
            ...
            >
                <div class="p-5">
                    ...
                    <div
                        class="flex justify-content-center mt-2 text-2xl text-center"
                    >
                        Create an unlimited lifetime access account on
                        DealHunter for FREE!
                    </div>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="field grid mt-2">
                            <div
                                class="col-12 flex justify-content-center text-2xl"
                            >
                                <div>
